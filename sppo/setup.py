...
# Adapted from alignment-handbook: httsps://github.com/huggingface/alignment-handbook
...
setup(
    ...
    author="uclaml",
    description="Self-Play Preference Optimization (SPPO)",
    long_description=open("README.md", "r", encoding="utf-8").read(),
    long_description_content_type="text/markdown",
    keywords="llm language-models transformers nlp deep-learning self-play",
    license="Apache",
    url="https://github.com/uclaml/SPPO",
    package_dir={"": "sppo"},
    packages=find_packages("sppo"),
    zip_safe=False,
